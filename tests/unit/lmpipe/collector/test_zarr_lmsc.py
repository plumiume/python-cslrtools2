...
class TestZarrLMSCContainerMode:
    ...
    def test_save_multiple_keys_container(
        ...
        collector = ZarrLandmarkMatrixSaveCollector[Literal["pose", "left_hand"]](per_key=False)
...
class TestZarrLMSCPerKeyMode:
    ...
    def test_save_multiple_keys_perkey(
        ...
        collector = ZarrLandmarkMatrixSaveCollector[Literal["pose", "left_hand"]](per_key=True)
