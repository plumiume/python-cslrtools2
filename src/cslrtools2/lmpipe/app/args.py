...
@namespace
class FaceArgs(mixin.ReprMixin, mixin.CommandMixin):
    pass
...
@namespace
class BothHandsArgs(mixin.ReprMixin, mixin.CommandMixin):
    pass


_set_ns_chain(plugins["both_hands"], BothHandsArgs, ("face", FaceArgs))


@namespace
class RightHandArgs(mixin.ReprMixin, mixin.CommandMixin):
    pass


_set_ns_chain(plugins["right_hand"], RightHandArgs, ("face", FaceArgs))


@namespace
class LeftHandArgs(mixin.ReprMixin, mixin.CommandMixin):
    pass
...
@namespace
class PoseArgs(mixin.ReprMixin, mixin.CommandMixin):
    pass
...
@namespace
class HolisticArgs(mixin.ReprMixin, mixin.CommandMixin):
    pass
