...
def _is_nswrapper(obj: Any) -> TypeGuard[NamespaceWrapper[Any]]:
    return isinstance(obj, NamespaceWrapper)

@runtime_checkable
class _EstimatorCreator(Protocol):
    def __call__(self, ns: Any) -> Estimator[str]: ...
...
def loader() -> dict[str, dict[str, PluginInfo[Any, Any]]]:
    ...
    for ep in entry_points:
        ...
        if not isinstance(creator, _EstimatorCreator):
            raise TypeError(
